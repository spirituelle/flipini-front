...
async function getMagasin( { page = 1,search}:{ page?: number, search?: string | undefined}){
    let user= {id: null};
        ...
        //     user= userRes.data;
        // }
        const res = await axios.get(`/api/newest-book?country_id=1&page=${page}&per_page=24&search=${search}`  )
        return { data: res.data.data as BookDetailsModel[], meta: res.data.meta as Meta};
